...
<head>
    ...
    <meta name="keywords" content="Watches Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design" />
        ...
        $(document).ready(function() {
            ...
            $('a[href^="FilterServlet"]').click(function(e) {
                ...
                $.ajax({
                    url: 'FilterServlet',
                    type: 'GET',
                    data: { category: category, page: page }, // Gửi dữ liệu thể loại và trang
                ...
                <ul class="product-categories color">
                    <c:forEach var="category" items="${products.getCategories()}">
                        <li class="cat-item cat-item-42">
                            <a href="FilterServlet?category=${category.category}&page=1">${category.category}</a>
