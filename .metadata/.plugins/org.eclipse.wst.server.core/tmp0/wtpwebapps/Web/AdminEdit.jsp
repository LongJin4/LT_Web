...
<body>
	...
	<form action="AdminEdit" method="post"
		...
		<label for="name">Tên sản phẩm:</label> <input type="text" id="name"
			name="name" placeholder="Nhập tên sản phẩm" required>
		...
		<label for="cost">Giá:</label> <input type="number" id="cost"
			name="cost" step="0.01" placeholder="Nhập giá sản phẩm" required>

		<!-- Số lượng -->
		<label for="quantity">Số lượng:</label> <input type="number"
			id="quantity" name="quantity" step="1" placeholder="Nhập số lượng"
			required>

		<!-- Chi tiết sản phẩm -->
		<label for="detail">Chi tiết sản phẩm:</label>
		<textarea id="detail" name="detail" rows="4"
			placeholder="Nhập chi tiết sản phẩm" required></textarea>
